  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        "glow-alfaromeo": "0 0 15px rgb(201 45 75 / 0.9)",
        "glow-alphatauri": "0 0 15px rgb(94 144 169 / 0.4)",
        "glow-alpine": "0 0 15px rgb(35 147 209 / 0.6)",
        "glow-astonmartin": "0 0 15px rgb(54 140 117 / 0.4)",
        "glow-ferrari": "0 0 15px rgba(250, 20, 53, 0.4)",
        "glow-haas": "0 0 15px rgb(182 186 189 / 0.4)",
        "glow-mclaren": "0 0 15px rgb(246 127 31 / 0.4)",
        "glow-mercedes": "0 0 15px rgb(108 211 190 / 0.4)",
        "glow-redbull": "0 0 15px rgb(54 113 198 / 0.7)",
